...
'********************************************
' DX7用Sysexファイルからバイナリデータ読み込み
'********************************************
Sub ReadSysexFileDX7(ByVal strfil As String, Optional strLibName As String)
    Dim buff() As Byte
    Dim fp As Long
    ...
    For c = 1 To Data_set
        ...
        '32Voiceバルクデータの場合（128バイト）
            ...
            OP6_KLS_RC = BinToDec(Left(DecToBin(Hex("&H" & buff(sr + 11)), 4), 2))
            OP6_KLS_LC = BinToDec(Right(DecToBin(Hex("&H" & buff(sr + 11)), 4), 2))
            ...
            OP5_KLS_RC = BinToDec(Left(DecToBin(Hex("&H" & buff(sr + 28)), 4), 2))
            OP5_KLS_LC = BinToDec(Right(DecToBin(Hex("&H" & buff(sr + 28)), 4), 2))
            ...
            OP4_KLS_RC = BinToDec(Left(DecToBin(Hex("&H" & buff(sr + 45)), 4), 2))
            OP4_KLS_LC = BinToDec(Right(DecToBin(Hex("&H" & buff(sr + 45)), 4), 2))
            ...
            OP3_KLS_RC = BinToDec(Left(DecToBin(Hex("&H" & buff(sr + 62)), 4), 2))
            OP3_KLS_LC = BinToDec(Right(DecToBin(Hex("&H" & buff(sr + 62)), 4), 2))
            ...
            OP2_KLS_RC = BinToDec(Left(DecToBin(Hex("&H" & buff(sr + 79)), 4), 2))
            OP2_KLS_LC = BinToDec(Right(DecToBin(Hex("&H" & buff(sr + 79)), 4), 2))
            ...
            OP1_KLS_RC = BinToDec(Left(DecToBin(Hex("&H" & buff(sr + 96)), 4), 2))
            OP1_KLS_LC = BinToDec(Right(DecToBin(Hex("&H" & buff(sr + 96)), 4), 2))
